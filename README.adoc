= reactive-dataflow-sysytems image:https://travis-ci.org/daggerok/reactive-dataflow-sysytems.svg?branch=master["Build Status", link="https://travis-ci.org/daggerok/reactive-dataflow-sysytems"]
